                  ...
                  while ($row = $categoryResult->fetch_assoc()) {
                    ...
                    echo "<td>
                            <div class='crud-operations'>
                              <a href='Admin-update-category.php?update_category=" . $row['cat_id'] . "'  class='update'>Update</a>
                              <a href='Admin-handle-categories.php?remove_category=" . $row['cat_id'] . "'  class='delete'>Delete</a>
                            </div>
                          </td>";
                    echo "</tr>";
                  }
