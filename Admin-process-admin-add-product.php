    ...
    if ($uploadOk == 0) {
        ...
        if (move_uploaded_file($_FILES["image"]["tmp_name"], $target_file)) {
            ...
            $productInsertQuery = "INSERT INTO products (product_name, product_description, product_price, product_condition, product_quantity, product_image_url, cat_id, seller_id) 
                               VALUES ('$productName', '$productDescription', '$productPrice', '$productCondition', '$productQuantity', ?, '$categoryId', '$sellerId')";
            ...
            echo '<script>
                    ...
                    window.location.href = "http://localhost/System_EduMarket-ecommerce_website/Admin-Add-Product.html";
                  </script>';
            exit();
        } else {
            echo '<script>
